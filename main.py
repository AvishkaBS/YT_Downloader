...
def download():
    ...
    try:
        ...
        if(res=="1"):
            ...
            except (AttributeError,pytube.exceptions.AgeRestrictedError,pytube.exceptions.ExtractError,pytube.exceptions.MembersOnly,pytube.exceptions.RecordingUnavailable,pytube.exceptions.VideoPrivate,pytube.exceptions.VideoRegionBlocked,pytube.exceptions.PytubeError):
...
def playlist_download():
    ...
    except (KeyError,pytube.exceptions.VideoUnavailable,pytube.exceptions.ExtractError):
        print(f'Video {url} is invalid, skipping.')
        return render_template("error.html")
